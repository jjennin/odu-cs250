...
using namespace std;
void readDateFromFile(int& year, int& day, int& month);
...
int main()
{
    ...
    readDateFromFile(year,day,month);
...
void readDateFromFile(int& year, int& day, int& month){
    ...
    inFile >> year >> garbg >> month >> garbg >> day;
    cout << "Date read: " << year << garbg << month << garbg << day;
}
void isALeapYear(int year, bool& leapyear){
